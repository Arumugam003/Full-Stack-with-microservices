...
docker pull arumugam003/new-api-gateway:latest
docker pull arumugam003/new-product-service:latest
docker pull arumugam003/new-order-service:latest
docker pull arumugam003/new-inventory-service:latest
docker pull arumugam003/new-notification-service:latest
...
kind load docker-image -n microservices arumugam003/new-api-gateway:latest
kind load docker-image -n microservices arumugam003/new-product-service:latest
kind load docker-image -n microservices arumugam003/new-order-service:latest
kind load docker-image -n microservices arumugam003/new-inventory-service:latest
kind load docker-image -n microservices arumugam003/new-notification-service:latest
